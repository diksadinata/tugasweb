...
<div class = "container">
<h1>Daftar anime</h1>
<form action="/edit/{{$listanime->id}}" method="post">
@csrf
@method ('put')
<table class="table">
    <thead class="black">
  ...
  <tbody>
    <tr>
      <td>
        <div class = "input0">
		<label ></label>  
		<input type="varchar" name="judul_anime" value="{{$listanime->judul_anime}}">
		</div>
  </td>
  <td>
  ...
  @foreach ($gen as $nl)
  <option value="{{$nl->id}}">{{$nl->genre}}</option>
  @endforeach
  </select>
  </div>
  </td>
      <td>
        <div class = "input1">
		<label ></label>  
		<input type="number" name="season"value="{{$listanime->season}}">
		</div>
  </td>
      <td><div class = "input2">
		<label ></label>  
		<input type="varchar" name="studio"value="{{$listanime->studio}}">
		</div>
  </td>
      <td><div class = "input3">
		<label ></label>  
		<input type="number" name="rating"value="{{$listanime->rating}}">
		</div></td>
      <td></div>
		<div class ="submit">
    <button class="btn btn-primary btn-sm">EDIT</button> 
    <button class="breadcrumb-item"><a href="/">kembali</a>
		</div>
